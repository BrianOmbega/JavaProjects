...
public class Driver {
	public static void main(String[] args) {
		...
		while(true) {
			...
			if(earnings > 0) {
				System.out.println("After day " + day + " you earned " + df.format(earnings) + " per share from your original buying price.");				
			}
			else if(earnings < 0) {
				System.out.println("After day "+ day + " you lost " + df.format(-earnings) + " per share from your original buying price.");
			}
			else {
